...
// In Replit's monorepo layout this app lived two levels below the repo
// root (imported/autonomous-audio-plugin-factory/), where .github/ actually
// is. This repo deliberately keeps the app AT the repo root instead (see
// the ORANGEJUCE-adoption plan) -- so root and app are the same directory
// here, not two levels apart.
const root = app;
