# Migrating web UI to ORANGEJUCE UI

Read `artifacts/orangejuce-ui/docs/AGENTS.md` and
`artifacts/orangejuce-ui/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/orangejuce-ui/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/orangejuce-ui/lib/utils`
- `@/hooks/use-toast` → `@workspace/orangejuce-ui/hooks/use-toast`
