# Consuming ORANGEJUCE UI in Expo apps

Read `artifacts/orangejuce-ui/docs/AGENTS.md` first. React Native does
...
`artifacts/orangejuce-ui/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/orangejuce-ui/tokens";
...
```tsx
import { nativeTheme } from "@workspace/orangejuce-ui/lib/native-theme";
import { useColors } from "@workspace/orangejuce-ui/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/orangejuce-ui/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/orangejuce-ui/components/native/badge";
import { Button } from "@workspace/orangejuce-ui/components/native/button";
import { Card } from "@workspace/orangejuce-ui/components/native/card";
```
...
Import and render
`@workspace/orangejuce-ui/components/native/button`, then run Expo
