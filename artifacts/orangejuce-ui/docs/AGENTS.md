...
workspace package (`@workspace/orangejuce-ui`): other artifacts depend
...
`@workspace/orangejuce-ui/components/...`. Never use a `@/` alias inside
...
for `@workspace/orangejuce-ui` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/orangejuce-ui` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/orangejuce-ui/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/orangejuce-ui/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/orangejuce-ui/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/orangejuce-ui/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/orangejuce-ui/docs/migrating-expo.md`
